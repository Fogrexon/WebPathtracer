(function (global, factory) {
    ...
    class GLTFLoader {
      ...
      async analize() {
        ...
        this.position = new Float32Array(buffer.slice(bufPos.byteOffset, bufPos.byteOffset + bufPos.byteLength));
        this.normal = new Float32Array(buffer.slice(bufNorm.byteOffset, bufNorm.byteOffset + bufNorm.byteLength));
        this.texcoord = new Float32Array(buffer.slice(bufTex.byteOffset, bufTex.byteOffset + bufTex.byteLength));
        this.indicies = new Int16Array(buffer.slice(bufInd.byteOffset, bufInd.byteOffset + bufInd.byteLength));
      }
